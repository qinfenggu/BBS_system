...
SECRET_KEY = '3n$^mvk7__sy%z0((g@ht&$cg#jj6jg8zhi$al!o+wl+sf^r%%'
...
# print(BASE_DIR)
# sys.path.insert(0, r'D:\Python进阶班\django_project\lgshop\apps')
...
INSTALLED_APPS = [
    ...
    'areas',            # 省市区三级联动
    'goods',            # 商品货物表
    'haystack',         # 全文检索。这个app是pip install django-haystack后，在这个django-haystack第三方包里面有它haystack这个app
    'carts',            # 购物车
    'orders',           # 订单
    'payment'           # 支付
...
# 点'用户中心'或'我的购物车这种'时，判断用户是否登录，如果没有登录，就重定向到我下面写的这个url
...
EMAIL_PORT = 25     # 发邮件端口
EMAIL_HOST_USER = '18646175116@163.com'  # 授权的邮箱
EMAIL_HOST_PASSWORD = 'CULXTHBHSENNMPWG'  # 邮箱授权时获得的密码，非注册登录密码
EMAIL_FROM = 'LG-<18646175116@163.com>'  # 发件人抬头。这个随便写。就是一个短信格式用的
...
FDFS_BASE_URL = 'http://8.136.222.236:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://8.136.222.236:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
